...
public class ExcelFileStorage {
	...
	public List<Blog> insertBlog(Blog blog) throws IOException {
		list.add(blog);
		return list;
...
//	//Retrieve the data from excel sheet and display in JSP
...
//			    break; 
//			   case 2: blog_posted_date = nextCell.getStringCellValue();
//			    } 
//		  } 
//	  } 
